...
export default function CategoryCard({ category }) {
  return (
    <div className="p-2 w-40 text-center rounded-3xl h-16 px-6 mb-4 mt-6 bg-sky-700 hover:bg-sky-600 duration-300 text-white flex items-center justify-center overflow-hidden hover:overflow-visible relative group">
      <svg
      ...
      <span className="duration-500">{category.title}</span>
    </div>
  );
}
